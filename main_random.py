...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 14 22:56:44 2023
...
resu_4= pd.read_csv('Results/resu_tot_f.csv',index_col=(0))
resu_ar= pd.read_csv('Results/resu_ar_f.csv',index_col=(0))
resu_rf= pd.read_csv('Results/resu_rf_f.csv',index_col=(0))
resu_nn= pd.read_csv('Results/resu_nn_f.csv',index_col=(0))

# Iterate over 1000 rows
for row in range(len(resu_4.columns),1000):
    try:
        ...
        res_nn = Compare_nn_exo(ts,X,ar=10,number_s=3,train_test_split=t_spt,opti_grid=config)
    ...
    resu_4.to_csv('Results/resu_tot_f.csv')
    resu_ar.to_csv('Results/resu_ar_f.csv')
    resu_rf.to_csv('Results/resu_rf_f.csv')
    resu_nn.to_csv('Results/resu_nn_f.csv')